...
#ifndef ALIGNER_SWVEC_H_
#define ALIGNER_SWVEC_H_
...
/**
 * Encapsulates matrix information calculated by the vector aligner.
 *
...
public:
	...
	VECMatrix(int cat = 0) : nvecPerCell_(4), matbuf_(cat) { }
	...
	/**
	 * Analyze a cell in the vector-filled dynamic programming matrix.  Determine &
	...
	VecListT         matbuf_;      // buffer for holding vectors
